...
import { Avatar, ChatDotRound, CirclePlus, Connection, Document, HomeFilled, Key, Lock, Monitor, Operation, QuestionFilled, Refresh, Search, Setting, Tickets, User, UserFilled, Warning } from '@element-plus/icons-vue'
    ...
    <el-dialog v-model="createTaskVisible" title="创建直播任务" width="min(92vw, 620px)" align-center>
      <el-form label-position="top">
        ...
        <el-form-item>
          ...
          <el-input v-model="taskForm.live_share_text" type="textarea" :rows="4" maxlength="2000" show-word-limit placeholder="请粘贴抖音直播分享内容，例如：正在直播，来和我一起支持Ta吧。复制下方链接，打开抖音直接观看直播！ https://v.douyin.com/xxxxxxxx/" />
        </el-form-item>
        <el-form-item>
          <template #label>
