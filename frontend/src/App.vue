...
async function qrLogin(id: number, scope: 'admin' | 'customer' = 'admin') {
  ...
  qr.value = ''; loginSessionId.value = null; loginStatus.value = 'waiting'; qrLoading.value = true; verificationCode.value = ''; verificationHint.value = ''; verificationOptions.value = []; verificationMethodId.value = ''; selectedVerificationMethod.value = null; loginPassword.value = ''; loginPasswordVerifySubmitting.value = false; qrDialogVisible.value = true
