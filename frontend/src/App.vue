...
async function closeQr(done?: () => void) {
  const id = loginSessionId.value
  stopQrTimer(); qrLoading.value = false; detectingLoginQr.value = false; qr.value = ''; verificationCode.value = ''; verificationHint.value = ''; verificationSubmitting.value = false; verificationOptions.value = []; verificationMethodId.value = ''; selectedVerificationMethod.value = null; verificationMethodSubmitting.value = false; loginPassword.value = ''; loginPasswordSubmitting.value = false; loginPasswordVerifySubmitting.value = false; loginSessionId.value = null
  if (id) {
